...
class LogUtils {
     ...
     * 日志输出级别NONE
     */
    static final int LEVEL_ALL = 7;

    /**
     * 日志输出级别V
     */
    static final int LEVEL_VERBOSE = 1;
    /**
     * 日志输出级别D
     */
     ...
     * 日志输出级别E
     */
    static final int LEVEL_ERROR = 5;
    /**
     * 日志输出级别S,自定义定义的一个级别
     */
    static final int LEVEL_SYSTEM = 6;
     ...
     *            存储路径
     */
//	  static void log2File(String log, String path) {
//		log2File(log, path, true);
//	}

//	  static void log2File(String log, String path, boolean append) {
...
//	}
     ...
     * @param msg 需要输出的msg
     */
    static void msgStartTime(String msg) {
     ...
     */
    static void elapsed(String msg) {
